...
// Add :class="{ 'is-opening': isOpening }" to handles
code = code.replace(
  /<div class="scroll-handle handle-left"/,
  '<div class="scroll-handle handle-left" :class="{ \'is-opening\': isOpening }"'
);
code = code.replace(
  /<div class="scroll-handle handle-right"/,
  '<div class="scroll-handle handle-right" :class="{ \'is-opening\': isOpening }"'
);
...
code = code.replace(/@keyframes scrollPhysicalExpand/, animationCSS + '\n@keyframes scrollPhysicalExpand');
