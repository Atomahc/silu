        ...
        <div class="scroll-wrapper">
          ...
          <div class="scroll-content" ref="scrollContainer" 
            ...
            <div class="panoramic-container">
              ...
              <DataBoxGovernance v-if="activeMarker && activeMarker.id === 13" style="top: 85%; left: 95.0%; transform: translate(-80%, calc(-100% - 1.5rem)); z-index: 100;" />
...
const markers = ref([
  ...
  { id: 2, x: 15, y: 54.0, title: '六代国门', bgImg: './laby1.png', bottomImg: './labyb.png', width: 'auto', height: '.5rem', desc: '霍尔果斯历经六代国门的建设与演变，展现了中国边境口岸的沧桑巨变与辉煌发展。', stats: [{ label: '演进历程', value: '6代迭代' }, { label: '通关能力', value: '提升100倍' }], htmlContent: marker2Html },
  { id: 4, x: 28, y: 68.0, title: '公路口岸通关区', bgImg: './labb3.png', bottomImg: './labbb.png', width: '1.8rem', height: '.5rem', desc: '高效智能的现代公路物流通关区，集查验、通关、物流于一体，实现快速高效通关。', stats: [{ label: '日均通关车次', value: '2500+辆' }, { label: '平均通关时间', value: '15分钟' }] },
  { id: 5, x: 16.0, y: 30.5, title: '通行中欧班列 6000列', subTitle: '过货量 1000万吨', bgImg: './labb1.png', bottomImg: './labbb.png', width: '2.5rem', height: 'auto', desc: '亚欧陆路交通干线核心枢纽节点，累计开行中欧班列数万列，辐射欧亚多个国家。', stats: [{ label: '开行线路', value: '75条' }, { label: '通达国家', value: '18个' }], htmlContent: marker3Html },
  ...
  { id: 22, x: 24.0, y: 30.0, title: '进出口货运量', subTitle: '2701.2万吨', bgImg: './labb1.png',  width: '2rem', height: '.8rem', desc: '进出口货运量统计。', stats: [{ label: '进出口货运量', value: '2701.2万吨' }] },
  ...
  { id: 13, x: 90.0, y: 67.5, title: '智慧治理指挥中心', bgImg: './labp1.png', bottomImg: './labpb.png', width: '2rem', height: '.5rem', desc: '依托大屏监控与全域感知系统，实现口岸人流、物流、车流及城市的精细化全天候运营管理。', stats: [{ label: '全域感知设备', value: '12000+' }, { label: '事件处置率', value: '99.8%' }] },
  ...
  { id: 16, x: 22.0, y: 53, title: '实有人口', subTitle: '7.1万人', bgImg: './laby1.png', width: '1.5rem', height: '.9rem', desc: '霍尔果斯市辖区常住及流动实有人口统计。', stats: [{ label: '实有人口', value: '7.1万' }] },
  { id: 17, x: 36.0, y: 38.0, title: '1-7月综保区', subTitle: '进出口总值48.6亿元', bgImg: './labb2.png', width: '2rem', height: '.9rem', desc: '综保区进出口总值显著增长。', stats: [{ label: '进出口总值', value: '48.6亿元' }] },
  ...
  { id: 20, x: 77.0, y: 70.0, title: '地区生产总值',subTitle: '122亿元', bgImg: './labg3.png',  width: '1.6rem', height: '.9rem', desc: '地区生产总值。', stats: [{ label: '地区生产总值', value: '122亿元' }] },
  { id: 21, x: 60.0, y: 44.0, title: '入出园人员', subTitle: '512万人次', bgImg: './labg3.png',  width: '1.6rem', height: '.9rem', desc: '入出园人员情况。', stats: [{ label: '入出园人员', value: '512万人次' }] },
])
</script>
